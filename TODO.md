...
**Решение:** Для v0.4-v0.5.x оставить текущий README с улучшенной навигацией. Полная реструктуризация документации - для v0.6.0+ когда API стабилизируется.
...
- **v0.6.x** - базовые тесты + docs/ структура + CI/CD
